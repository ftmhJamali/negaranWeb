var moment = (function (e) {
      ...
      e.exports = (function () {
        ...
        function A(e) {
          var t,
            a,
            n = {};
          for (a in e) m(e, a) && (t = E(a)) && (n[t] = e[a]);
          return n;
        }
        var F = {};
        function z(e, t) {
        ...
        function Z(e, t) {
          ...
          for (I.lastIndex = 0; a >= 0 && I.test(e); )
            (e = e.replace(I, n)), (I.lastIndex = 0), (a -= 1);
          return e;
        }
        var B = /\d/,
          K = /\d\d/,
        ...
        function xe(e, t) {
          return function (a) {
            return null != a
              ? (Pe(this, e, a), s.updateOffset(this, t), this)
              : Oe(this, e);
          };
        }
        function Oe(e, t) {
        ...
        function et() {
          ...
          for (i.sort(e), d.sort(e), _.sort(e), o.sort(e), t = 0; t < 7; t++)
            (d[t] = ce(d[t])), (_[t] = ce(_[t])), (o[t] = ce(o[t]));
        ...
        U("H", ["HH", 2], 0, "hour"),
          ...
          U("hmmss", 0, 0, function () {
            return (
              "" + tt.apply(this) + J(this.minutes(), 2) + J(this.seconds(), 2)
            );
          }),
          U("Hmm", 0, 0, function () {
          ...
          Me("Hmm", function (e, t, a) {
            var n = e.length - 2;
            (t[De] = T(e.substr(0, n))), (t[ke] = T(e.substr(n)));
          }),
          Me("Hmmss", function (e, t, a) {
            var n = e.length - 4,
              s = e.length - 2;
          ...
          return (
            a &&
              ...
              ((t =
                a[fe] < 0 || a[fe] > 11
                  ? fe
                  : a[pe] < 1 || a[pe] > We(a[ye], a[fe])
                  ? pe
                  : a[De] < 0 ||
                    a[De] > 24 ||
                    (24 === a[De] &&
                      (0 !== a[ke] || 0 !== a[Te] || 0 !== a[ge]))
                  ? De
                  : a[ke] < 0 || a[ke] > 59
                  ? ke
                  : a[Te] < 0 || a[Te] > 59
        ...
        function Tt(e) {
          ...
          if (_) {
            for (h(e).iso = !0, t = 0, a = pt.length; t < a; t++)
              if (pt[t][1].exec(_[1])) {
                (s = pt[t][0]), (n = !1 !== pt[t][2]);
                break;
              }
          ...
          if (e._f !== s.ISO_8601)
            if (e._f !== s.RFC_2822) {
              ...
              var t,
                ...
                o = 0;
              for (
                n = Z(e._f, e._locale).match(N) || [], t = 0;
                t < n.length;
                t++
              )
                (r = n[t]),
        ...
        function Ct(e, t) {
          ...
          return t._isUTC
            ? ((a = t.clone()),
              (n =
                (D(e) || o(e) ? e.valueOf() : xt(e).valueOf()) - a.valueOf()),
        ...
        for (_a = "S"; _a.length <= 9; _a += "S") Me(_a, ua);
        ...
        (la.add = Qt),
          ...
          (la.diff = function (e, t, a) {
            ...
            if (!(n = Ct(e, this)).isValid()) return NaN;
            switch (
              ((s = 6e4 * (n.utcOffset() - this.utcOffset())), (t = E(t)))
            ) {
              case "year":
                r = ea(this, n) / 12;
                break;
          ...
          (la.from = function (e, t) {
            return this.isValid() && ((D(e) && e.isValid()) || xt(e).isValid())
          ...
          (la.isAfter = function (e, t) {
            ...
            return (
              ...
              ("millisecond" === (t = E(d(t) ? "millisecond" : t))
          ...
          (la.set = function (e, t) {
            ...
            else if (b(this[(e = E(e))])) return this[e](t);
            return this;
          }),
        ...
        function La(e, t, a) {
          ...
          var n,
            s = [];
          for (n = 0; n < 12; n++) s[n] = Ma(e, n, a, "month");
          return s;
        }
        function Ya(e, t, a, n) {
          "boolean" == typeof e
          ...
          var s,
            r = ct(),
            i = e ? r._week.dow : 0;
          if (null != a) return Ma(t, (a + i) % 7, n, "day");
          var d = [];
          for (s = 0; s < 7; s++) d[s] = Ma(t, (s + i) % 7, n, "day");
          return d;
        }
        (ha.calendar = function (e, t, a) {
          ...
          (ha.monthsParse = function (e, t, a) {
            ...
            if (this._monthsParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "MMM" === t
                    ? -1 !== (s = He.call(this._shortMonthsParse, i))
                      ? s
                      : null
                    : -1 !== (s = He.call(this._longMonthsParse, i))
                    ? s
                    : null
                  : "MMM" === t
                  ? -1 !== (s = He.call(this._shortMonthsParse, i))
          ...
          (ha.monthsRegex = function (e) {
            return this._monthsParseExact
              ...
              : (m(this, "_monthsRegex") || (this._monthsRegex = Ie),
          ...
          (ha.monthsShortRegex = function (e) {
            return this._monthsParseExact
              ...
              : (m(this, "_monthsShortRegex") || (this._monthsShortRegex = Ne),
          ...
          (ha.weekdaysParse = function (e, t, a) {
            ...
            if (this._weekdaysParseExact)
              return function (e, t, a) {
                ...
                return a
                  ? "dddd" === t
                    ? -1 !== (s = He.call(this._weekdaysParse, i))
                      ? s
                      : null
                    : "ddd" === t
                    ? -1 !== (s = He.call(this._shortWeekdaysParse, i))
                      ? s
                      : null
                    : -1 !== (s = He.call(this._minWeekdaysParse, i))
                    ? s
                    : null
                  : "dddd" === t
                  ? -1 !== (s = He.call(this._weekdaysParse, i))
          ...
          (ha.weekdaysMinRegex = function (e) {
            return this._weekdaysParseExact
              ...
              : (m(this, "_weekdaysMinRegex") || (this._weekdaysMinRegex = Xe),
        ...
        var Pa = Oa("milliseconds"),
          ...
          Ja = Oa("years"),
          Na = Math.round,
          Ia = { ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11 },
          Ca = Math.abs;
        function Ra(e) {
          return (e > 0) - (e < 0) || +e;
        }
        ...
        return (
          ...
          (Ga.as = function (e) {
            ...
            switch (((t = this._days + Math.round(ka(this._months))), e)) {
              case "week":
                return t / 7 + n / 6048e5;
              case "day":
                return t + n / 864e5;
  ...
  function (e, t, a) {
    ...
    var n = a(0),
      ...
      c = /T/i,
      h = /[\+\-]?\d+(\.\d{1,3})?/,
      M = { jm: "jmonth", jmonths: "jmonth", jy: "jyear", jyears: "jyear" },
      L = {},
      Y = "DDD w M D".split(" "),
      y = "M D w".split(" "),
      f = {
    ...
    function w(e, t) {
      ...
      return "jday" === e ? (e = "day") : "jd" === e && (e = "d"), e;
    }
    function v(e, t, a, n) {
      var s = e._d;
      e._isUTC
    ...
    function b(e, t, a) {
      ...
      switch (e) {
        ...
        case "jMMM":
        case "jMMMM":
          H((s = n.localeData(a._l).jMonthsParse(t)))
            ? (a._isValid = !1)
            : (r[1] = s);
          break;
        case "jD":
    ...
    function O(e, t, a) {
      ...
      return (
        ...
        r < s - 7 && (r += 7),
        (n = W(e).add(r, "d")),
        { week: Math.ceil(n.jDayOfYear() / 7), year: n.jYear() }
      );
    }
    function P(e, t, a, r, i) {
      "boolean" == typeof a && ((i = r), (r = a), (a = void 0));
      var d = F(this);
      e &&
        "string" == typeof e &&
        !t &&
      ...
      var _,
        o,
        u,
        m = { _i: e, _f: t, _l: a, _strict: r, _isUTC: i },
        l = e,
        c = t;
      if (t) {
        if (
          ...
          return (function (e, t) {
            var a,
              ...
              d,
              _ = e._f.length;
            if (0 === _) return P(new Date(NaN));
            for (a = 0; a < _; a += 1)
              (n = e._f[a]),
                (i = 0),
                (s = P(e._i, n, e._l, e._strict, t)).isValid() &&
                  ((i += s._jDiff),
        ...
        (_ = x(m)),
          (function (e) {
            var t,
              ...
              o = _.length;
            for (t = 0; t < o; t += 1)
              (n = (S((a = _[t]), e).exec(r) || [])[0]) &&
                (r = r.slice(r.indexOf(n) + n.length)),
                f[a] instanceof Function || ((d += a), n && (i += n));
            (e._i = i), (e._f = d);
          })(m),
          (t = "YYYY-MM-DD-" + m._f),
          (e =
            T(_[0], 4) + "-" + T(_[1] + 1, 2) + "-" + T(_[2], 2) + "-" + m._i);
      }
      return (
        (o = i ? n.utc(e, t, a, r) : n(e, t, a, r)),
      ...
      var n = (function (e, t, a) {
        ...
        return (function (e) {
          ...
          if ((n = e - d) >= 0) {
            if (n <= 185)
              return (
                (a = 1 + N(n, 31)), (t = I(n, 31) + 1), { jy: r, jm: a, jd: t }
              );
            n -= 186;
          } else (r -= 1), (n += 179), 1 === i.leap && (n += 1);
          return (
            (a = 7 + N(n, 30)), (t = I(n, 30) + 1), { jy: r, jm: a, jd: t }
          );
        })(U(e, t, a));
      })(e, t + 1, a);
      return (n.jm -= 1), n;
      ...
      var n = (function (e, t, a) {
        return G(
          (function (e, t, a) {
            var n = R(e);
            return (
              U(n.gy, 3, n.march) + 31 * (t - 1) - N(t, 7) * (t - 7) + a - 1
            );
          })(e, t, a)
        );
      })(e, t + 1, a);
    ...
    function R(e) {
      ...
      for (i = 1; i < _ && ((a = (t = d[i]) - m), !(e < t)); i += 1)
        (u = u + 8 * N(a, 33) + N(I(a, 33), 4)), (m = t);
      return (
        (u = u + 8 * N((r = e - m), 33) + N(I(r, 33) + 3, 4)),
        4 === I(a, 33) && a - r == 4 && (u += 1),
    ...
    function G(e) {
      ...
      return (
                ...
                5 *
                  N(
                    I(
                      (t =
                        (t = 4 * e + 139361631) +
                        4 * N(3 * N(4 * e + 183187720, 146097), 4) -
                        3908),
                      1461
                    ),
                    4
        ...
        (s = I(N(a, 153), 12) + 1),
        { gy: N(t, 1461) - 100100 + N(8 - s, 6), gm: s, gd: n }
      );
    }
    !(function () {
      for (var e; Y.length; )
        (e = Y.pop()), (f["j" + e + "o"] = D(f["j" + e], e));
      for (; y.length; ) (e = y.pop()), (f["j" + e + e] = p(f["j" + e], 2));
      f.jDDDD = p(f.jDDD, 3);
    })(),
      k(
        (function (e) {
            ...
            L[e] ||
              (L[e] = (function (e) {
                var t,
                  a = e.match(s),
                  n = a.length;
                for (t = 0; t < n; t += 1) f[a[t]] && (a[t] = f[a[t]]);
                return function (s) {
                  var r = "";
                  for (t = 0; t < n; t += 1)
                    r +=
      ...
      (W.fn.jMonth = function (e) {
        ...
        return H(e)
          ...
          : ((a = A(this)),
            ...
            (e = I(e, 12)) < 0 && ((e += 12), this.jYear(this.jYear() - 1)),
      ...
      (W.fn.jDate = function (e) {
        var t, a;
        return "number" == typeof e
          ? (v(this, (a = J((t = A(this)).jy, t.jm, e)).gy, a.gm, a.gd),
            n.updateOffset(this),
            this)
          : A(this).jd;
      }),
      (W.fn.jDay = function (e) {
        return "number" == typeof e
          ? n.fn.day.call(this, e - 1)
          : (n.fn.day.call(this) + 1) % 7;
      }),
      (W.fn.dayOfYear = function (e) {
        return F(this)
          ? W.fn.jDayOfYear.call(this, e)
          : n.fn.dayOfYear.call(this, e);
      }),
      (W.fn.jDayOfYear = function (e) {
        var t =
          Math.round(
            (W(this).startOf("day") - W(this).startOf("jYear")) / 864e5
          ) + 1;
      ...
      (W.fn.weekYear = function (e) {
        return F(this)
          ? W.fn.jWeekYear.call(this, e)
          : n.fn.weekYear.call(this, e);
      }),
      ...
      (W.fn.subtract = function (e, t) {
        ...
        return (
          ...
          "jyear" === (t = w(t, this))
            ...
            : "jmonth" === t
            ? this.jMonth(this.jMonth() - e)
            : n.fn.subtract.call(this, e, t),
          this
        );
      }),
      (W.fn.startOf = function (e) {
        return "jweek" === (e = w(e, this))
          ...
          ? ("jyear" === e && this.jMonth(0),
            ...
            this.milliseconds(0),
            this)
          : n.fn.startOf.call(this, e);
      }),
      (W.fn.endOf = function (e) {
        return void 0 === (e = w(e, this)) || "milisecond" === e
          ? this
          : this.startOf(e)
              .add(1, "isoweek" === e ? "week" : e)
              .subtract(1, "ms");
      ...
      (W.fn.isSame = function (e, t) {
        return "jyear" === (t = w(t, this)) || "jmonth" === t
          ? n.fn.isSame.call(this.clone().startOf(t), e.clone().startOf(t))
          : n.fn.isSame.call(this, e, t);
      }),
      (W.fn.isBefore = function (e, t) {
        return "jyear" === (t = w(t, this)) || "jmonth" === t
          ? n.fn.isBefore.call(this.clone().startOf(t), e.clone().startOf(t))
          : n.fn.isBefore.call(this, e, t);
      }),
      (W.fn.isAfter = function (e, t) {
        return "jyear" === (t = w(t, this)) || "jmonth" === t
          ? n.fn.isAfter.call(this.clone().startOf(t), e.clone().startOf(t))
          : n.fn.isAfter.call(this, e, t);
      }),
      (W.fn.clone = function () {
        return W(this);
      }),
      ...
      (W.fn.locale = function (e) {
        return (
          e &&
            n.changeCalendarSystemByItsLocale &&
      ...
      (W.from = function (e, t, a) {
        ...
        W.locale(t);
        var s = W(e, a);
        return s.locale(n), W.locale(n), s;
      }),
      ...
      n.locale("en"),
      (W.jConvert = { toJalali: z, toGregorian: J });
  },
  function (e, t) {
